...
def create_validation_splits(train_paths: List[Path], train_labels: List[int], test_paths: List[Path], test_labels: List[int], num_samples_per_class: int, seed: int, class_to_idx: Dict[str, int]) -> Tuple[List[Path], List[int], List[Path], List[int]]:
    random.seed(seed)
...
def get_nico_pp_dataloaders(data_root: str, batch_size: int, num_val_samples_per_class: int, rndm_seed: int, num_workers: int, image_size: int) -> Tuple[DataLoader, DataLoader, DataLoader, DataLoader]:
    ...
    in_domain_val_paths, in_domain_val_labels, out_of_domain_val_paths, out_of_domain_val_labels = create_validation_splits(train_paths = train_paths, train_labels = train_labels, test_paths = test_paths, test_labels = test_labels, num_samples_per_class = num_val_samples_per_class, seed = rndm_seed, class_to_idx = class_to_idx)
    ...
    in_domain_val_dataset = NICOPPDataset(in_domain_val_paths, in_domain_val_labels, transform = data_transform)
    out_of_domain_val_dataset = NICOPPDataset(out_of_domain_val_paths, out_of_domain_val_labels, transform = data_transform)
