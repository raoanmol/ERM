...
2. Download `img_align_celeba_png.zip`
3. Unzip this file
4. Put it in `./data/celeba/`
5. Ultimately your images should be in `./data/celeba/img_align_celeba/` where `./` is your project root directory